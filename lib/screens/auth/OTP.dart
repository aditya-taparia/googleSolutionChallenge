...
class OTP extends StatefulWidget {
  ...
  final String number;
  const OTP(this.verificationIdFinal, this.number) : super();

  @override
  _OTPState createState() => _OTPState(verificationIdFinal, number);
}

class _OTPState extends State<OTP> {
  final String verificationIdFinal;
  final String number;
  _OTPState(this.verificationIdFinal, this.number);
